...
const user_product_grpc = new UserProductService('localhost:50051', grpc.credentials.createInsecure());
// const user_product_grpc = new UserProductService('172.18.0.3:50051', grpc.credentials.createInsecure());
